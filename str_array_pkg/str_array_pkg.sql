...
-------------------------------------------------------------------
-- Create an array from a range of strings within another
...
-------------------------------------------------------------------
-- Renumber the array indices so it starts from 1 (or p_first_idx)
-- with no gaps.
-- Warning: does not handle array indices < 1
-------------------------------------------------------------------
