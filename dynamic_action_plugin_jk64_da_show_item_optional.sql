...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(36155120457372697)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(36155320164372699)
,p_plugin_id=>wwv_flow_api.id(36155120457372697)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Set Value Required = No'
