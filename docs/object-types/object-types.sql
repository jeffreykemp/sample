...
-- 2022-07-19 jkemp
--
-- How to use SQL object types to build a hierarchical data type system
-- purpose-built for a custom purpose.
--
...
-- Generic "Array" type
--
-- Note that each element in the array is itself a base_t, which means we can
-- have arrays of strings, arrays of numbers, arrays of dates, or arrays of
-- any mixture of these.
--
-- We can even have arrays of arrays, which themselves can be arrays of any
-- of these things.
--
